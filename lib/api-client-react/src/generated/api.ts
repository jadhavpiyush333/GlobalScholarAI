...
export const getListUniversitiesUrl = (params?: ListUniversitiesParams) => {
  ...
  return stringifiedParams.length > 0
    ? `/api/knowledge/universities?${stringifiedParams}`
    : `/api/knowledge/universities`;
};
...
export const getListUniversitiesQueryKey = (
  ...
  return [`/api/knowledge/universities`, ...(params ? [params] : [])] as const;
};
...
export const getGetUniversityUrl = (id: number) => {
  return `/api/knowledge/universities/${id}`;
};
...
export const getUniversity = async (
  ...
  return customFetch<UniversityWithDetails>(getGetUniversityUrl(id), {
    ...options,
    method: "GET",
  });
};
...
export const getGetUniversityQueryKey = (id: number) => {
  return [`/api/knowledge/universities/${id}`] as const;
};
...
export type GetUniversityQueryResult = NonNullable<
  Awaited<ReturnType<typeof getUniversity>>
>;
export type GetUniversityQueryError = ErrorType<OpenaiError>;
...
export const getListProgramsUrl = (params?: ListProgramsParams) => {
  ...
  return stringifiedParams.length > 0
    ? `/api/knowledge/programs?${stringifiedParams}`
    : `/api/knowledge/programs`;
};
...
export const getListProgramsQueryKey = (params?: ListProgramsParams) => {
  return [`/api/knowledge/programs`, ...(params ? [params] : [])] as const;
};
 ...
 */
export const getListVisaRequirementsUrl = (
  params?: ListVisaRequirementsParams,
) => {
  const normalizedParams = new URLSearchParams();
  ...
  return stringifiedParams.length > 0
    ? `/api/knowledge/visa-requirements?${stringifiedParams}`
    : `/api/knowledge/visa-requirements`;
};

export const listVisaRequirements = async (
  params?: ListVisaRequirementsParams,
  options?: RequestInit,
): Promise<VisaRequirement[]> => {
  return customFetch<VisaRequirement[]>(getListVisaRequirementsUrl(params), {
    ...options,
    method: "GET",
  });
};

export const getListVisaRequirementsQueryKey = (
  params?: ListVisaRequirementsParams,
) => {
  return [
    `/api/knowledge/visa-requirements`,
...
export const getListVisaRequirementsQueryOptions = <
  TData = Awaited<ReturnType<typeof listVisaRequirements>>,
  TError = ErrorType<unknown>,
>(
  params?: ListVisaRequirementsParams,
  options?: {
    query?: UseQueryOptions<
      Awaited<ReturnType<typeof listVisaRequirements>>,
      TError,
      TData
    >;
    request?: SecondParameter<typeof customFetch>;
  ...
  const queryKey =
    queryOptions?.queryKey ?? getListVisaRequirementsQueryKey(params);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof listVisaRequirements>>
  > = ({ signal }) =>
    listVisaRequirements(params, { signal, ...requestOptions });
...
export type ListVisaRequirementsQueryResult = NonNullable<
  Awaited<ReturnType<typeof listVisaRequirements>>
>;
export type ListVisaRequirementsQueryError = ErrorType<unknown>;

/**
 * @summary List visa requirements by country
 */

export function useListVisaRequirements<
  TData = Awaited<ReturnType<typeof listVisaRequirements>>,
  TError = ErrorType<unknown>,
>(
  params?: ListVisaRequirementsParams,
  ...
  const queryOptions = getListVisaRequirementsQueryOptions(params, options);
...
export const listFields = async (
  ...
  return customFetch<FieldInsight[]>(getListFieldsUrl(), {
    ...options,
    method: "GET",
  });
};
 ...
 */
export const getGetFieldUrl = (slug: string) => {
  return `/api/fields/${slug}`;
};
...
export const getField = async (
  ...
  return customFetch<FieldInsight>(getGetFieldUrl(slug), {
    ...options,
    method: "GET",
  });
};

export const getGetFieldQueryKey = (slug: string) => {
  return [`/api/fields/${slug}`] as const;
};
...
>(
  ...
  const queryKey = queryOptions?.queryKey ?? getGetFieldQueryKey(slug);

  const queryFn: QueryFunction<Awaited<ReturnType<typeof getField>>> = ({
    signal,
  }) => getField(slug, { signal, ...requestOptions });
...
export type GetFieldQueryResult = NonNullable<
  Awaited<ReturnType<typeof getField>>
>;
export type GetFieldQueryError = ErrorType<OpenaiError>;
...
>(
  ...
  const queryOptions = getGetFieldQueryOptions(slug, options);
